        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition_type', models.CharField(
                    max_length=255, verbose_name='大会種別')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='players', to='hit_record_app.Competition', verbose_name='大会')),
            ],
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='matches', to='hit_record_app.Competition', verbose_name='大会')),
            ],
        ),
        migrations.CreateModel(
            name='Hit',
            fields=[
                ...
                ('shoot_order', models.CharField(
                    max_length=255, verbose_name='立ち位置')),
                ('hit', models.CharField(max_length=255, verbose_name='的中')),
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='hits', to='hit_record_app.Competition', verbose_name='大会')),
                ('match', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                            related_name='hits', to='hit_record_app.Match', verbose_name='試合')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                             related_name='hits', to='hit_record_app.Player', verbose_name='選手')),
            ],
        ),
    ]
